...
public class MainActivity extends Activity {
    ...
    private Button mTestButton;/**STUDENT*/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mReader.setOnStateChangeListener(new OnStateChangeListener() {
            ...
            public void onStateChange(int slotNum, int prevState, int currState) {
                ...
                if(stateStrings[prevState]=="Absent"&&stateStrings[currState]=="Present"){
                    TransmitProgress Uid=getUid();
                    if(Uid!=null&&Uid.response!=null){
                        sUid="\n UID: "+fromBuffer(Uid.response, Uid.responseLength);
                    }
                }
    ...
    /**ITR_STUDENT**/
    public TransmitProgress getUid(){
    ...
    private String fromBuffer(byte[] buffer, int bufferLength) {
